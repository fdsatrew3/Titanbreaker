...
-- additional events that not supported by data driven...
LinkLuaModifier( "modifier_hero_lua_events", "modifiers/modifier_hero_lua_events", LUA_MODIFIER_MOTION_NONE )